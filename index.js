...
mongoose.connect('mongodb+srv://marinkec7:<password>@myflixdb.f1d5x.mongodb.net/myFlixDB?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true });
